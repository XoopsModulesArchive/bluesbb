...
A new post has been added in the {X_MODULE} module at our site.  It was posted in the thread "{THREAD_NAME}" in the topic "{TOPIC_NAME}".

Follow this link to view the post in the topics (where you can reply):
{POST_URL}
